# Adam: A Method for Stochastic Optimization - page-anchored PDF text
...
An important property of Adam’s update rule is its careful choice of √ stepsizes. Assuming  = 0, the
                                           timestep t is ∆t = α · m
effective step taken in parameter space at √                                   √ effective stepsize has
                                                                  b t / vbt . The
...
will be smaller. When (1 − β1 ) = 1 − β2 we         √ have that | b
                                                                  m t /         p1 therefore |∆t | < α. In
                                                                          vbt | <
...
as the ith element. We define g1:t,i ∈ Rt as a vector that contains the ith dimension of the gradients
                                                                                     β2
over all iterations till t, g1:t,i = [g1,i , g2,i , · · · , gt,i ]. Also, we define γ , √β1 . Our following
                                                                                       2
                                                                            1
theorem holds when the learning rate αt is decaying at a rate of t− 2 and first moment running
...
Our Theorem 4.1 implies when the data features are sparse and bounded gradients, the           √ sum-
                                                                  Pd
mation term can be much smaller than its upper bound                    kg     k
                                                                          1:T,i 2  <<    dG  ∞ T and
Pd p                       √                                        i=1
   i=1   T vbT,i << dG∞ T , in particular if the class of function and data features are in the form of
                                                                            Pd
...
αt = α · t −1/2
                , namely θt − α · t −1/2
                                         ·mb t / limβ2 →1 vbt = θt − α · t −1/2
                                                                                 · gt / t · i=1 gt2 =
                                                                                         −1
             qP
                    t
                    i=1 gt . Note that this direct correspondence between Adam and Adagrad does
θt − α · gt /            2
...
From, kg1:T,i k22 − gT,i
                     2         T ,i
                         + 4kg1:T     2 ≥ kg1:T,i k2 − gT,i , we can take square root of both side and
                                  ,i k2
                                                   2    2
...
have,
                           q                                         2
                              ...
                              kg1:T,i k22 − gT,i      1:T,i k2 −
                                                  ...
                                                  q
Rearrange the inequality and substitute the                    2 term,
                                                kg1:T,i k22 − gT,i
                                                    s
                              q                          2
                                                       gT,i
...
Published as a conference paper at ICLR 2015
                           ...
                           β2                                                   β2
Lemma 10.4. Let γ , √β1 . For β1 , β2 ∈ [0, 1) that satisfy √β1 < 1 and bounded gt , kgt k2 ≤ G,
                          2                                    2
...
using the update rules in Algorithm 1,
          T              T −1             p             PT
         X    mb 2t,i    X    mb 2t,i        1 − β2T ( k=1 (1 − β1 )β1T −k gk,i )2
             p        =       p       +               q
         t=1
                 vt,i
                tb       t=1
                                 vt,i
                                tb        (1 − β1T )2 T PT (1 − β )β T −j g 2
                                                                       j=1             2        2             j,i
                         T −1               p    T
                         X             1 − β2T X T ((1 − β1 )β1T −k gk,i )2
                                  b 2t,i
                                  m
                     ≤     p      +                q
                       t=1
                             vt,i
                            tb      (1 − β1T )2 k=1 T PT (1 − β )β T −j g 2
                                                       j=1       2 2        j,i
                         T −1          p            T
                         X     mb2        1 − β2T X T ((1 − β1 )β1T −k gk,i )2
                     ≤         p t,i +                q
                           t=1
                                 vt,i
                                tb     (1 − β1T )2 k=1 T (1 − β )β T −k g 2
                                                                2                           2         k,i
                         T −1               p                                    T                           T −k
                         X        b 2t,i
                                  m        1 − β2T (1 − β1 )                2    X                  β12
                     ≤         p      +            p                T √                                               kgk,i k2
                           t=1
                                tb
                                 vt,i   (1 − β1T )2 T (1 − β2 ) k=1     β2
                         T
                         X −1                        XT
                               mb2          T
                     ≤         p t,i + p                 γ T −k kgk,i k2
                           t=1
                                 vt,i
                                tb       T (1 − β2 ) k=1
                                       ...
                                       tb t,i t=1  t(1 − β  )
                                                 ...
                                                 ≤          p                        tγ j
                                                      t=1        t(1 − β2 ) j=0
                                                                                            ...
                                                                                            P
For γ < 1, using the upper bound on the arithmetic-geometric series,                            t tγ
                                                                                                          t         1
                                                                                                               < (1−γ)2:
                                 ...
                                 t=1
                                      tb
                                       v t,i (1 − γ)      2
                                                     ...
                                                     β2
To simplify the notation, we define γ , √β1 . Intuitively, our following theorem holds when the
                                                      2
                                                 1
learning rate αt is decaying at a rate of t− 2 and first moment running average coefficient β1,t decay
...
both sides of the above update rule, we have,
                                          ...
                                          2αt     β1,t            β1,t )                         b t,i
                                                                                                 m
(θt+1,i − θ,i∗ )2 =(θt,i − θ,i∗ )2 −            ( p mt−1,i + (1 − p gt,i )(θt,i − θ,i∗ ) + αt2 ( p )2
                                        1 − β1t    vbt,i            vbt,i                         vbt,i
...
gt,i (θt,i − θ,i∗ ) =                             ∗ 2
                    ...
                    +              √       (θ − θt,i ) αt−1 1           +                     ( p )2
                      (1 − β1,t ) αt−1 ,i                     vbt−1,i
                                                                  4            2(1 − β  1,t )    vbt,i
                                                                     
                          1                  ∗ 2
                                                                        p                β1,t                   p
                  ≤                 (θt,i − θ,t ) − (θt+1,i − θ,i∗ )2    vbt,i +                   (θ∗ − θt,i )2 vbt−1,i
                    2αt (1 − β1 )                                                2αt−1 (1 − β1,t ) ,i
